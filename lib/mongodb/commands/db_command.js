...
/**
Represents a command for the database
@constructor
...
/**
Creates a command asking for information from db using the criteria from selector
@function
@param db the database
@param selector Criteria for the information we are searching for
*/
